...
/**
 * Color scheme:
 * Board Background: Light Gray Blue — (230, 240, 250)
 * Pits: Cool Gray — (180, 200, 220)
 * Mancalas: Darker Blue — (140, 170, 200)
 * Stones: Matte Black
 */
public class ModernBoardStyle implements BoardStyle{
    ...
    public void drawPit(Graphics2D g2, Rectangle2D bounds, int stones, boolean isPlayerAPit) {
        ...
        g2.setColor(new Color(180, 200, 220)); //Cool Gray
        g2.fill(pit);
    ...
    public void drawMancala(Graphics2D g2, Rectangle2D bounds, int stones, boolean isPlayerAMancala) {
        ...
        g2.setColor(new Color(140, 170, 200)); //Darker  Blue
        g2.fill(mancala);
        g2.setColor(Color.BLACK);
        g2.draw(mancala);
